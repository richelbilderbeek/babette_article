...
\begin{abstract}
  ...
  \textbf{1. }
    ...
    It comes with the graphical programs BEAUti 2, DensiTree and Tracer,
  ...
  \textbf{3. }
    We describe \verb;rbeast2;'s usage, the novel functionality it provides
...
Here, to provide such functionality we present \verb;rbeast2;:
...
\verb;rbeast2; has 7 exported function to run and help run BEAST2.
One function is used to run BEAST2, others
allow the user to check if a BEAST2 configuration file is indeed valid.

\verb;rbeast2; has 20 exported function to parse the BEAST2 output
files and analyse the created posterior. \verb;rbeast2; gives the
...
\verb;rbeast2; will then execute BEAST2 with that file, and
parses the output. The output, named \verb;out;, is a list of
parameter estimates, posterior phylogenies (one for each alignment)
and operator acceptances. 

The default settings for BEAUti (and thus \verb;rbeast2;) are, 
...
The following script shows how to do this in \verb;rbeast2;:
...
\verb;rbeast2; allows for the same functionality of Tracer. 
...
estimates. This is called the "burn-in". To remove the burn-in
in \verb;rbeast2;:
...
Then, to calculate the effective sample sizes in \verb;rbeast2;:
...
of, for example, the estimated birth rate in \verb;rbeast2;:
...
\verb;rbeast2; allows for the same functionality of DensiTree.
...
topology and branch lengths. To visualize the same in \verb;rbeast2;:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{rbeast2 development and other resources}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\verb;rbeast2; is free, libre and open source software available from the official R package archive at 
...
\verb;rbeast2; follows Hadley Wickham's style guide \cite{style_guide}, which improves software quality \cite{fang2001}.
\verb;rbeast2; is dependent on multiple packages, which are 
\verb;APE; \cite{APE}, 
