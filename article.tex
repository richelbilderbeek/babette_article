...
\begin{abstract}
  ...
  \textbf{1. }
    In het onderzoeksveld van de fylogenetica is BEAST2 een van de meest gebruikte 
    hulpprogramma's. Het is gebundeld met de grafische gebruikers interface
    BEAUti 2, DensiTree en Tracer, om BEAST2 configuratiebestanden te maken
    en om BEAST2 output bestanden te interpreteren.
  ...
  \textbf{2. }
    Hier presenteren wij een gratis, vrij en open-source package, \verb;babette;:
  ...
  \textbf{3. }
    Wij beschrijven hoe \verb;babette; te gebruiken is en de nieuwe mogelijkheden die het biedt
    vergeleken met de originele programma's, begeleidt met enkele voorbeelden. \\
  \textbf{4. }
    Omdat \verb;babette; ontworpen is om van hoge kwaliteit en uitbreidbaar te zijn, 
    sluiten wij af met het beschrijven van de verdere ontwikkeling van dit package. \\
\end{abstract}
...
For exploring many trees (for instance from simulations), when doing a sliding-window
analysis, or for a more thorough sensitivity analysis, one would like to loop through 
