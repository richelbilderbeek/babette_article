...
a BEAST2 configuration file, with \verb;babette; the same 
can be created by a simple one-liner. Unlike \verb;BEASTmasteR;,
\verb;rBEAST; and \verb;RBeast;, \verb;babette; implements all of Tracer's
primary functionality. There exists no package that calls BEAST2 from R.
\verb;babette; sets up BEAST2, runs it, and analyzes its
...
\verb;babette; uses a software architecture that expects to be extended.
...
To remove the burn-in from all parameter estimates in \verb;babette;,
