...
\begin{figure}
  ...
  \caption{
    Workflow using GUI tools. From an alignment, BEAUti is used to create a 
    BEAST2 configuration file. That file is run by BEAST2. The results
    are visualized using DensiTree and Tracer.
  }
  \label{fig:workflow}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
